...
const themeConfig = {
  ...
  navigationSize: 210 /* 260 Number in px(Pixels) /*! Note: This is for Vertical navigation menu only */,
  collapsedNavigationSize: 68 /* 68 Number in px(Pixels) /*! Note: This is for Vertical navigation menu only */,
